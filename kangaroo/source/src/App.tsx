...
export default function App() {
  ...
  return (
    <div className="min-h-screen relative" style={{ backgroundColor: '#FFFFFF' }}>
      {/* Background Image - 65% of page height, full width */}
      <div 
        style={{ 
          position: 'absolute',
          top: 0,
          ...
          right: 0,
          height: '65vh',
          backgroundImage: 'url(https://kangaroocareindia.com/static/media/doctors-bg.283b058066d03c3acbec.jpg)',
      ...
      {/* Fixed Footer */}
      {!isAdminRoute && (
        <Footer onBookAppointment={handleBookAppointmentClick} />
      )}
      </div>
    </div>
  );
