      ...
      <div className="bg-white rounded-2xl shadow-lg p-6">
        ...
        <div className="flex gap-4 mb-6">
          <button
            ...
            style={inputMethod === 'symptoms' ? {backgroundColor: '#EF586F'} : undefined}
          >
            Select Symptoms
          </button>
          <button
            ...
            style={inputMethod === 'text' ? {backgroundColor: '#EF586F'} : undefined}
          >
            Describe Issue
          </button>
        </div>
        ...
        {inputMethod === 'symptoms' && (
          <div>
              ...
              {commonSymptoms.map(symptom => {
                ...
                return (
                  <button
                    ...
                    `}
                    style={{
                      backgroundColor: isSelected ? '#7E52A020' : 'white',
                      color: isSelected ? '#7E52A0' : undefined
                    }}
                  >
                    <div className="flex items-center gap-2">
                      {isSelected && (
                        <CheckCircle2 className="w-4 h-4" style={{ color: '#7E52A0' }} />
                      )}
            ...
            {selectedSymptoms.length > 0 && (
              <div className="mt-4 p-3 rounded-lg" style={{ backgroundColor: '#7E52A020' }}>
                <p className="text-sm" style={{ color: '#7E52A0' }}>
