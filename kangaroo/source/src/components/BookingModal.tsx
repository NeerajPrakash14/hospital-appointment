  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-2 sm:p-4 bg-black/50 backdrop-blur-sm animate-in fade-in duration-200">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-4xl max-h-[95vh] sm:max-h-[90vh] overflow-y-auto animate-in zoom-in-95 duration-200">
        {/* Header */}
        <div className="sticky top-0 text-white p-4 sm:p-6 flex items-center justify-between" style={{ backgroundColor: '#EF586F' }}>
          <div className="flex-1 min-w-0 pr-2">
            <h3 className="mb-1 text-base sm:text-lg">Book Appointment</h3>

            <p className="font-semibold truncate" style={{ opacity: 0.9, color: '#7E52A0', fontSize: '14px' }}>
              with <span className="font-semibold" style={{ opacity: 0.9, color: '#7E52A0', fontSize: '16px' }}>Dr. {doctor.name} </span>
            </p>
          </div>
          <button
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="p-4 sm:p-6 space-y-4 sm:space-y-5">
          ...
          <div>
            ...
            <input
              ...
              style={{ '--focus-ring-color': '#EF586F' } as React.CSSProperties}
              onFocus={(e) => e.currentTarget.style.boxShadow = '0 0 0 2px #EF586F'}
                          ...
                          return (
                            <button
                              ...
                              className={`flex-shrink-0 flex flex-col items-center justify-center p-2 sm:p-3 rounded-xl border-2 transition-all min-w-[65px] sm:min-w-[80px] ${
                                isSelected
                                  ? 'border-[#EF586F] shadow-md'
                                  : 'border-gray-200 hover:border-gray-300'
                              }`}
                              style={{
                                backgroundColor: isSelected ? '#EF586F' : 'white',
