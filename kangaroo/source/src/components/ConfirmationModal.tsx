  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-2 sm:p-4 bg-black/50 backdrop-blur-sm animate-in fade-in duration-200">
      <div className="bg-white rounded-2xl shadow-2xl max-w-lg w-full max-h-[95vh] sm:max-h-[90vh] overflow-y-auto animate-in zoom-in-95 duration-200">
        {/* Success Header */}
        <div className="text-white p-4 sm:p-8 text-center rounded-t-2xl relative overflow-hidden" style={{ background: 'linear-gradient(135deg, #EF586F 0%, #0d7a8a 100%)' }}>
          ...
          <div className="relative">
            <div className="w-16 h-16 sm:w-20 sm:h-20 bg-white rounded-full mx-auto mb-3 sm:mb-4 flex items-center justify-center shadow-lg">
              <CheckCircle2 className="w-10 h-10 sm:w-12 sm:h-12" style={{ color: '#EF586F' }} />
            </div>
        ...
        <div className="p-4 sm:p-8">
          {/* Booking ID */}
          <div className="rounded-xl p-3 sm:p-4 mb-4 sm:mb-6 text-center border-2" style={{ backgroundColor: '#d4e8e3', borderColor: '#EF586F' }}>
            <p className="text-xs sm:text-sm font-medium mb-1" style={{ color: '#EF586F' }}>Booking ID</p>
            <p className="font-bold text-base sm:text-lg" style={{ color: '#EF586F' }}>{bookingId}</p>
          </div>
          ...
          <div className="space-y-3 sm:space-y-4 mb-4 sm:mb-6">
            {bookingData.doctor && (
              <div className="flex items-start gap-2 sm:gap-3 pb-3 sm:pb-4 border-b border-gray-100">
                <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-lg flex items-center justify-center flex-shrink-0" style={{ backgroundColor: '#d4e8e3' }}>
                  <User className="w-4 h-4 sm:w-5 sm:h-5" style={{ color: '#EF586F' }} />
                </div>
                <div>
                  ...
                  <p className="text-xs sm:text-sm" style={{ color: '#7E52A0' }}>{bookingData.doctor.specialty}</p>
                </div>
              </div>
            )}
            ...
            <div className="flex items-start gap-2 sm:gap-3 pb-3 sm:pb-4 border-b border-gray-100">
              <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-lg flex items-center justify-center flex-shrink-0" style={{ backgroundColor: '#d4e8e3' }}>
                <Calendar className="w-4 h-4 sm:w-5 sm:h-5" style={{ color: '#EF586F' }} />
              </div>
              <div>
                ...
                <div className="flex items-center gap-1 mt-1" style={{ color: '#EF586F' }}>
            ...
            <div className="flex items-start gap-2 sm:gap-3 pb-3 sm:pb-4 border-b border-gray-100">
              <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-lg flex items-center justify-center flex-shrink-0" style={{ backgroundColor: '#d4e8e3' }}>
                <Phone className="w-4 h-4 sm:w-5 sm:h-5" style={{ color: '#EF586F' }} />
              </div>
          ...
          {/* Info Box */}
          <div className="rounded-xl p-3 sm:p-4 mb-4 sm:mb-6 border-2" style={{ backgroundColor: '#FFF8E7', borderColor: '#7E52A0' }}>
