    ...
    <section className="relative px-4 py-8 md:py-12">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-6 md:mb-8 mt-5">
          {/* <div className="inline-flex items-center gap-2 px-4 py-2 text-white rounded-full mb-6 mt-5" style={{ backgroundColor: '#006776' }}>
        ...
        {/* <div className="mt-0 grid grid-cols-2 md:grid-cols-4 gap-4 max-w-4xl mx-auto">
          ...
          {/* <h1 className="mb-4 text-blue-900" style={{ color: '#F9AA1C' }}>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <button
            ...
            onMouseEnter={(e) => e.currentTarget.style.borderColor = '#006776'}
            onMouseLeave={(e) => e.currentTarget.style.borderColor = 'transparent'}
          >
            <div className="absolute top-0 right-0 w-32 h-32 rounded-full -mr-16 -mt-16 opacity-10 group-hover:opacity-20 transition-opacity" style={{ backgroundColor: '#006776' }} />
            
            <div className="relative">
              <div className="flex items-center gap-3 mb-4">
                <div className="w-14 h-14 rounded-xl flex items-center justify-center transition-colors" style={{ backgroundColor: '#00677610' }}>
                  <Calendar className="w-7 h-7 transition-colors" style={{ color: '#006776' }} />
                </div>
              ...
              <div className="flex items-center transition-colors" style={{ color: '#F9AA1C' }}>
          ...
          >
            ...
            <div className="relative">
              ...
              <div className="flex items-center text-white">
                <span className="mr-2" style={{ color: '#e89d4d' }}>Book Now</span>
                <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
              </div>
            </div>
          </button>
